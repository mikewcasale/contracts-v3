...
describe('BancorArbitrage', () => {
    ...
    describe('trades', () => {
        ...
        //
        ////		for (let k = 0; k < allExchanges.length; k++) {
        //        let routeExchanges = allRouteIds[k];
        //        let routeExchangesNames = [
        //            allExchanges[routeExchanges[0]],
        //            allExchanges[routeExchanges[1]],
        //            allExchanges[routeExchanges[2]]
        //        ];
        //
        //        let exchangeName1 = routeExchangesNames[0];
        //        let exchangeName2 = routeExchangesNames[1];
        //        let exchangeName3 = routeExchangesNames[2];
        //
        //        let exchangeId1 = routeExchanges[0];
        //        let exchangeId2 = routeExchanges[1];
        //        let exchangeId3 = routeExchanges[2];

        //        let arbMsgNew = arbMsg.concat(exchangeName1.toString());
