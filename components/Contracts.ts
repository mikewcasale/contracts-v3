...
const getContracts = (signer?: Signer) => ({
    ...
    MockUniswapV3Router: deployOrAttach('MockUniswapV3Router', MockUniswapV3Router__factory, signer),
    MockUniswapV3Pool: deployOrAttach('MockUniswapV3Pool', MockUniswapV3Pool__factory, signer),
    MockBancorNetworkV2: deployOrAttach('MockBancorNetworkV2', MockBancorNetworkV2__factory, signer),
